    ...
    <main style={styles.page}>
      ...
      <div style={styles.panel}>
        ...
        <div style={styles.quick}>
          <button style={styles.quickBtn} onClick={() => setBet(Math.max(1, bet / 2))}>½</button>
          <button style={styles.quickBtn} onClick={() => setBet(bet * 2)}>2×</button>
          <button style={styles.quickBtn} onClick={() => setBet(balance)}>MAX</button>
        </div>
